...
field reducer-demo dt=0.125 gain=1.0 deadband=0.5

module council field=reducer-demo belief=0.0 prior=0.0 precision=1.0 action-gain=1.0
...
module child field=reducer-demo belief=0.0 prior=0.0 precision=1.0 action-gain=1.0 parent=council
...
flow reducer-flow field=reducer-demo duration=1.0 expect-theta=council.b:0.25 tolerance=0.000001
commit reducer-commit module=council expect-trits=0+- expect-balance=admissible
...
compile reducer-ir source=native_reducer.cdc expect-ops=3 expect-flow=1 expect-commit=1 expect-nest=1
