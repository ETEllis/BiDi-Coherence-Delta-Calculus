...
| runtime-checked | Executed by the C runtimes or freshness checks in `scripts/verify.sh` | bridge lookup/generation, reducer flow/accepted commit/held commit/nest, replay JSON, surface/council/evolve, paper compile |
