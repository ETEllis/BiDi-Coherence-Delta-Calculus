...
`council_bridge.cdc`, `system.cdc`, `relations.cdc`, and `trace_windows.cdc`.
...
| G | bridge runtime, native reducer runtime, native compile/interpreter IR, finite proof checking, council deliberation, source evolution |
...
native reducer runtime: flow/commit/nest/compile/interpret/proof/council/evolve checks pass
